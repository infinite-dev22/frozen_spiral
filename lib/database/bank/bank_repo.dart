...
class BankRepo extends BankRepoInterface {
  ...
  Future<Map<String, dynamic>> fetchAll({Map<String, dynamic>? body}) async {
    ...
    try {
      ...
      var response = await dio.get(
        '${currentUser.url}/api/admin/bank',
  ...
  Future<Map<String, dynamic>> fetch(int id) async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(currentUser.url.replaceRange(0, 8, ''), 'api/admin/bank/$id')
            .toString(),
      );
  ...
  Future<dynamic> post(Map<String, dynamic> data, int id) async {
    ...
    try {
      ...
      var response = await dio.post(
        Uri.https(
                currentUser.url.replaceRange(0, 8, ''), 'api/admin/bank/create')
            .toString(),
